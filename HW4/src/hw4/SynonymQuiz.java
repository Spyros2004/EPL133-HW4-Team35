...
/**
 * The SynonymQuiz class represents a synonym quiz with a list of synonym
 * questions.
 * 
 * @author kkypri06 , ssachm02
 * @version 1.1
 * @since 10/04/22
 *
 */
public class SynonymQuiz {
	...
	/**
	 * This is the list of {@link SynonymQuestion} in the quiz.
	 * 
	 * @since 1.0
	 */
	...
	/**
	 * Constructs a new SynonymQuiz object from a given file. Each line of the file
	 * contain a word followed by a list of choices and then the answer (choices for
	 * the quiz).
	 * 
	...
	/**
	 * Runs a similarity test on the quiz questions using MostSimilarWord and the
	 * semantic descriptors we created at SemanticDescriptors.
	 * 
	 * @param filename             the name of the file to read the quiz questions
	 *                             from
	 * @param semantic_descriptors the HashMap of semantic descriptors to use in the
	...
	public static double runSimilarityTest(String filename,
		...
		System.out.print("Success rate is : " + Math.round(percentage * 100) + '%');
		return percentage;
	}
